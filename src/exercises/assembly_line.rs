mod assembly_line {
    const MAX_PRODUCTIVITY_PER_HOUR: f64 = 221.0;
    fn production_rate(speed: u8) -> f64 {
    ...
    pub fn production_rate_per_hour(speed: u8) -> f64 {
        production_rate(speed) * MAX_PRODUCTIVITY_PER_HOUR
    }
    pub fn working_items_per_minute(speed: u8) -> u32 {
        (production_rate(speed) * MAX_PRODUCTIVITY_PER_HOUR / 60.0) as u32
    }
}
